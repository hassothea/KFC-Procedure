...
- $K$-step: $K$-means algorithm with $M$ Bregman divergences $\mathcal{B}=B_1, ... B_M$, see, for example, [Banerjee (2005)](chrome-extension://oemmndcbldboiebfnladdacbdfmadadm/https://www.jmlr.org/papers/volume6/banerjee05b/banerjee05b.pdf). 
